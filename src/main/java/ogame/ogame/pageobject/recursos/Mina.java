...
public class Mina {
	...
	private final Integer constanteUniverso = 4;
	
	Parameters params = new Parameters();
	
	public Integer getConstanteUniverso() {
		return constanteUniverso;
	}
...
//	public void setNombre(WebDriver driver, Integer i) {
//		this.nombre = params.getElementos().get(i);
//	}
	...
	public void setSegundosRequeridos(String mina) {
		this.segundosRequeridos = (int) Math.ceil(getSegundosInicialRequerido()*Math.pow(getConstant(), getNivel())/getConstanteUniverso());
	}
